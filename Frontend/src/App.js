...
const getAll = async () => {
  let res_bus = await fetch("http://localhost:3000/bus/all")
  let res_tempo = await fetch("http://localhost:3000/tempo/all")
  let res_car = await fetch("http://localhost:3000/car/all");
