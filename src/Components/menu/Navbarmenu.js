...
const Navbarmenu = () => {
    ...
    {
        await(window.location.href="http://localhost:3000/auth/google")
    }
            ...
            <div className="row">
                <div className="header__middle__logo">
                    <NavLink exact activeClassName='is-active' to="/">
                        <img className="NavBarLogoimg" src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Bus-logo.svg/1024px-Bus-logo.svg.png" alt="logo" /> 
                    </NavLink>
                </div>
                ...
                <div className="leftNav">
                    <ul>
                      ...
                      <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Offline`}><Link to = "/rpool"> Bus Live Status   </Link> </NavLink></li>
                      <li><NavLink onClick={toggleClass} activeClassName='is-active' to={`/Offline`}><Link to = "/bushire"> Drivers</Link> </NavLink></li>
                    </ul>
                </div>
